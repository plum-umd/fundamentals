...
@title[#:style 'unnumbered #:tag "lab13"]{Lab 13: Applying the Design Process (2/2)}
...
@section[#:style 'unnumbered #:tag "lab13:assign4"]{Continue Designing with Style}

Continue your review of @secref{assign4}.
