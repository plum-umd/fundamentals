...
\begin{itemize}
\item Lots of universities want their students to be proficient in an
  industrial object-oriented programming language by the end of the first year.
\item Teaching Java on Day 1 is a flawed approach.
\item Teaching functional programming in Semester 1 and Java in Semester 2 is a flawed approach.
\item We contribute a solution: a gradual transition from functional
  programming to object-oriented programming that culminates in
  industrial language proficiency.
\end{itemize}
