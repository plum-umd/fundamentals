...
@title[#:style 'unnumbered #:tag "ex9"]{Exercise 9}

@bold{Due}: Wednesday, July 24, 11:59:59 PM EST.

@section[#:tag "ex9:overview"]{Revising Assignment 2}

Revise your solution to @secref{assign2} to fix any issue and improve
your code.  Submitting a revision earns you full credit.  Your
revisions will be graded and substituted for your assignment 2 grade
(if it is higher than your original grade).
...
assignment 2 score will remain unchanged):

@itemlist[

@item{Name your file @tt{assign2-revised.rkt}; submit this and only this file.}
...
get credit for the exercise; your assignment 2 score will stay as it is.}



Things that are worth doing to improve your score on assignment 2:
...
For a bonus, change the language to ISL and use list abstraction
functions wherever appropriate.  Do so successfully and we will
replace a 0 quiz grade with a 1.
