...
class Dino{
    ...
    Dino(String eyecolor, boolean male, int teeth){
...
class LectureExamples{
    ...
    Dino d1 = new Dino("blue", true, 2);
    Dino d2 = new Dino("yellow", true, 70);
    Dino d3 = new Dino("black", false, 6);
    Dino d4 = new Dino("chartreuse", false, 50);
    Dino d5 = new Dino("red", false, 8);
    Dino d6 = new Dino("magenta", true, 40);
    Dino d7 = new Dino("indigo", true, 33);
